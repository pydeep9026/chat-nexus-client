...
const Chatmenu=()=>{     
    ...
    async function setcontactfunc() {
        if (currentuser) {
          ...
          toast.error("no users logged in");
        }
      }
    ...
    return(
        ...
        <Contacts className="contactcont" contacts={contacts} chatchange={handlechatchange} currentuser={currentuser}/>
        {
          currentchat===undefined?
          <Welcome/>:
          <Chat  className="chatcont" currentchat={currentchat} currentuser={currentuser}  Socket={Socket} />
        }
        </div>
